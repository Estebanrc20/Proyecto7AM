...
const ForgetPasswordPage = props => {
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      email: Yup.string().required("Por favor, introduzca su correo electronico"),
    }),
    onSubmit: (values) => {
          ...
          <Row className="justify-content-center">
            <Col md={8} lg={6} xl={4}>
              <Card className="overflow-hidden">
                ...
                <CardBody className="p-4">
                  ...
                  <Form
                    ...
                    <div className="mb-3">
                      <Label className="form-label" htmlor="useremail">Correo Electronico</Label>
                      <Input
                        name="email"
                    ...
                    <div className="row  mb-0">
                      <div className="col-12 text-end">
                        <button className="btn btn-primary w-md waves-effect waves-light" type="submit">Restaurar</button>
                      </div>
                    </div>
              ...
              <div className="mt-5 text-center">
                <p>¿Lo recuerdas? <Link to="/login" className="fw-medium text-primary"> Iniciar sesión aqui </Link> </p>
                <p>
